...
abstract class APIRequest {
    ...
    private static final Map<String, String> gitToFreshFields = new HashMap<>(){{
        put("bio", "description");
    ...
    private static final String[] viableFields = {"description", "address", "name"};
    private static final String[] uniqueFields = {"email", "twitter_id"};


    public String getData(String askDescription) throws Exception{ // check if user input is correct
     ...
     public abstract JSONObject getRequest() throws Exception; // get request
